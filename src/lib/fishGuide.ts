...
const GUIDES: Record<CatalogFish, Omit<FishGuide, 'name'>> = {
  鲫鱼: {
    aliases: '鲫瓜、喜头',
    intro: '上海公园湖与河道最常见的底层鱼。喜群居。高压稳压时靠边贴底觅食；闷热低压会离底找氧，口往往变轻，不是抢食。不编造溶氧或水温数字。',
  ...
  鲻鱼: {
    aliases: '乌头、脂眼鲻',
    intro: '河口广盐性，刮食藻类和有机碎屑。上海滨江、闸口可见。手竿商品饵有效；教材和国内钓技都写路亚效果差。',
    habitat: '滨江缓流、闸口。',
    tips: [
      {
        style: '台钓',
  ...
  鲈鱼: {
    ...
    intro:
      '上海路亚塘里的「鲈鱼」几乎都是引进种大口黑鲈（加州鲈）：结构区伏击，配合饲料养殖常见。长江口、滨江调查里的鲈才是中国花鲈（七星鲈），走潮沟和急流拐弯。拟饵按塘里的加州鲈给：软虫贴结构、晨昏浅层米诺。不要把花鲈标点套到塘鲈上。',
    habitat: '塘：坝头乱石、增氧机、障碍；河口花鲈：潮沟、急流拐弯。',
    tips: [
      {
        style: '路亚',
        items: ['塘鲈用铅头钩软虫跳底贴结构，晨昏可换浅层米诺。', '搜索坝头、乱石带与增氧机附近。', '滨江花鲈改急流拐弯，涨潮近、退潮远。'],
      },
    ],
  },
  翘嘴: {

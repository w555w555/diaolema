...
- 水色指数（开口程度）：黄绿 +6（较好）；肥浊 -6（偏挑，盛夏无风再 -4）；恶水 -28 且分数封顶 34（不宜）；瘦清默认 0（一般），视觉猎手（鲈/翘嘴/白条/红鳍鲌/鳡/黑鱼，或未点鱼的路亚）+4；泥浆默认 -10，视觉 -12，底栖鲫鲤鲶黄颡塘鲺青 -6，鳜 -4。塘保养仅收费塘/路亚塘：刚换水 -12，刚调水 -10，回稳 +4，老水 -4。未知不加不减。不把养殖光色实验写进水色芯片。

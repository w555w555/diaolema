...
- 饵形：鲫/鳊/白条偏拉饵；鲤/草/青或高气压/大风偏搓饵；草/鳊气温≥26 改颗粒/玉米；黄颡/鲶用虫饵；路亚为拟饵。
- 台钓标点：鲫→草边凹岸/草洞；鲤→凸岸缓坡亮水；草→草边；青→深潭桥墩；翘嘴/白条→深浅交界；黑鱼→草洞。雨天加进水口缓流；正午改荫凉桥洞；晨昏近岸浅滩。
- 路亚拟饵（`planLurePick`）：按对象鱼 + 气温/时段/降水。翘嘴上海公园浅湖夏 **5–7g** 斜切亮片（淀山湖/滴水湖等大水面可加到 7–12g）、冬春 12–20g 远投、晨昏波扒、夜钓勺型 7–10g；黑鱼草区 10–14g 雷蛙走停、**中鱼后等两三秒再抽**；鳜铅头钩卷尾 7–10g（白天跳底诱攻，不默认中上层巡游）/夜 VIB；鲈按上海路亚塘大口黑鲈给结构软虫或浅层米诺，近岸轻荡不必远投；白条瓜子亮片 1.5–3g；鲶胡须佬贴底。清水银白、浊水红头金、夜钓橙红。来源：渔夫者/钓鱼007、小浪纹/碧溪上上海浅湖、渔钓者、酷钓鱼、酷米网。运行时不联网。
...
- `planLurePick`：上海浅湖翘嘴夏 5–7g、冬春 12–20g、夜钓 7–10g。
